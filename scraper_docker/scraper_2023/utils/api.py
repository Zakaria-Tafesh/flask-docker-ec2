...
class Request:
    ...
    def call_map(self):
        ...
        self.update_params()
        headers = {'authority': 'www.torontopropertyhunters.com', 'method': 'POST',
                   'path': '/property-search/res/includes/search_application/get_listings_for_map.asp',
                   'scheme': 'https', 'Accept-Encoding': 'gzip, deflate, br',
                   'Accept-Language': 'en-US,en;q=0.9,ar-AE;q=0.8,ar;q=0.7', 'Cache-Control': 'no-cache',
